...
namespace AdminTools.Controllers
{
    ...
    public class GenerateDataController : ControllerBase
    {
        ...
        private readonly IBaseRespository<ProductEntity> productRepository;
        ...
        {
            await productRepository.Insert(throlledProductEntityObjects, correlationToken);
        }

        private async Task DeletetProduct(List<ProductEntity> throlledProductEntityObjects, string correlationToken)
        {
            await productRepository.Delete(throlledProductEntityObjects, correlationToken);
        }
    }
}